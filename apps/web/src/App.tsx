  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .op-clerk .cl-headerTitle { color: #e8e4df !important; }
        .op-clerk .cl-headerSubtitle { color: #a09a92 !important; }
        .op-clerk .cl-formFieldLabel { color: #a09a92 !important; }
      `}</style>
